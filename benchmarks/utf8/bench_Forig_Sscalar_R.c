// bench_Forig_Sscalar_R — Forig (orig accumulate ASCII scan) + Sscalar + R (full-buffer slow).
...
utf8_fast_orig(const uint8_t* buf, size_t buf_sz)
{
